 ...
 */
export function getDMHYChannelMetadata(req: NextRequest): NewznabChannelMetadata {
 ...
 */
export const DMHY_CAPABILITIES: NewznabCapabilities = {
  server: {
    version: '1.0',
    title: 'Vercel Veil Indexer',
  },
