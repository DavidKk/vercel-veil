    ...
    <div className="flex h-screen w-full flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <div className="relative z-10 flex h-full flex-col py-4 sm:py-6 gap-4 sm:gap-6 overflow-hidden">
        <div className="flex flex-col gap-4 sm:gap-6 flex-1 px-4 sm:px-6 min-h-0">
          {/* Poster Image */}
          <div
            className="relative aspect-[2/3] w-full max-w-[160px] sm:max-w-[200px] mx-auto overflow-hidden rounded-xl bg-gray-800 shadow-2xl flex-shrink-0 max-h-[40vh]"
          ...
          <div className="flex flex-col gap-3 sm:gap-4 flex-1 min-h-0">
            ...
            <div className="flex flex-col gap-2 flex-shrink-0 max-h-[25vh] overflow-hidden" style={{ display: isDetailsExpanded ? 'none' : 'flex' }}>
            ...
            {movie.genres && movie.genres.length > 0 && (
              <div className="flex flex-wrap gap-2 flex-shrink-0 max-h-[10vh] overflow-hidden" style={{ display: isDetailsExpanded ? 'none' : 'flex' }}>
